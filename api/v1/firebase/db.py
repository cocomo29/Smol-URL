...
cred = credentials.Certificate(r"api\v1\firebase\config.json") # You can get this file from the Firebase console by going to Project Settings > Service Accounts > Generate New Private Key.
